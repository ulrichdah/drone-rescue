...
# declare -a test_types=("4040_15_" "4040_20_" "4040_25_")
# declare -a test_types=("3030_15_" "3030_20_" "3030_25_")
declare -a test_types=("2020_15_" "2020_20_" "2020_25_")
nb_tests=30
...
for test_type in "${test_types[@]}"; do
    ...
    if [[ $test_type == *"_25_"* ]]; then
        sed -i "107s/quantity=\".*\" /quantity=\"25\" /" sparse_sar.argos
        sed -i "6s/.*/NUMBER_OF_ROBOTS = 25/" config/search_example/parameters.bzz
    fi

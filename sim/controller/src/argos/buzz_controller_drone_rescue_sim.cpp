...
const std::string TARGET_FILE = "/home/docker/drone-rescue/sim/controller/src/argos/results/target_steps.txt";
const std::string RELAY_FILE = "/home/docker/drone-rescue/sim/controller/src/argos/results/relay_steps.txt";
